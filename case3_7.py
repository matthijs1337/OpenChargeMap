...
with tab1: 
    ...
    with col2b:
        ...
        aantal = aantal.sort_values('Aantal', ascending = False)
        aantal = aantal.reset_index()
        st.dataframe(aantal[['Provincie', 'Aantal']], 400,455)
...
with tab2:
    ...
    with col1a:
        ...
        st.markdown("<p style='text-align: center;'><b>Voorspeling voor de bezetting van de laadpaal</b> </p>", unsafe_allow_html=True)
        ...
        with col2a:
            #st.markdown("**Histogram van de bezetting van de laadpaal in 2018**")
            st.markdown("<p style='text-align: center;'><b>Histogram van de bezetting van de laadpaal in 2018</b> </p>", unsafe_allow_html=True)
            ...
            fig2.update_layout(
                            xaxis=dict(title = 'Bezetting van de paal in uur'),
            ...
            fig2.add_annotation(x=laadpaaldata1['ConnectedTime'].median()  - 0.7, y=810, text="mediaan", showarrow=False)
            fig2.add_vline(x=laadpaaldata1['ConnectedTime'].mean(), line_width=1,line_dash="dot", line_color="black")
            fig2.add_annotation(x=laadpaaldata1['ConnectedTime'].mean() + 0.75, y=810, text="gemiddelde", showarrow=False)
            
            st.plotly_chart(fig2)
            
        with col3a:
            #st.markdown("**Kansdichtheidsfunctie voor de oplaatijd**")
            st.markdown("<p style='text-align: center;'><b>Kansdichtheidsfunctie voor de oplaatijd</b> </p>", unsafe_allow_html=True)
            ...
            fig3.update_layout(
                            xaxis=dict(title = 'Oplaadtijd in uur'),
                            yaxis=dict(title = "Kansdichtheid"))
...
with tab3:
    ...
    with col1:
        #st.markdown("**Cumulatieve som van het aantal elektrische auto's per jaar**")
        st.markdown("<p style='text-align: center;'><b>Cumulatieve som van het aantal elektrische auto's per jaar</b> </p>", unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown("<p style='text-align: center;'><b>Meest voorkochte auto's</b> </p>", unsafe_allow_html=True)
        ...
        merken_elektrischvoertuig2.columns = ['Merk', 'Handelsbenaming', 'Aantal', 'Catalogusprijs']
        merken_elektrischvoertuig2 = merken_elektrischvoertuig2.sort_values('Aantal', ascending = False)
        merken_elektrischvoertuig2 = merken_elektrischvoertuig2.reset_index()
        st.dataframe(merken_elektrischvoertuig2[['Merk', 'Handelsbenaming', 'Aantal', 'Catalogusprijs']])
